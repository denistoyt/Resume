...
<head>
	...
	<title>РосАтмос | Поставки компрессорного оборудования и сервисное обслуживание по всей России</title>
...
<body>
	<header>
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-push-2 col-sm-6 col-sm-push-3 header-content">
					<div class="logo">
						<img src="img/logo-2.png" alt="">
						<span>Поставки компрессорного оборудования <br> и сервисное обслуживание по всей России</span>
					</div>
					<div class="header-contacts">
						<div class="mail">
							<span>Пишите</span>
							<a href="mailto:zakaz+205132@rosatmos.su">zakaz+205132@rosatmos.su</a>
						</div>
						<div class="telephone">
							<span>Звоните бесплатно</span>
							<a href="tel:8(800) 600-67-92">8(800) 600-67-92</a>
						</div>
					</div>
	...
	<section class="intro">
		<div class="container">
			<div class="row">
				<div class="col-xs-12 intro-slogan">
					<span class="intro-split"></span>
					<h1>Получите лучшее предложение по компрессорному <br> оборудованию среди 17 производителей в соотношении <br> цена-качество с доставкой от 1 дня</h1>
				</div>
				<div class="intro-content">
					<!-- картинка -->
					<div class="intro-content__left">
						<img src="img/work.jpg" alt="картинка">
					</div>
					<!-- форма -->
					<div class="intro-content__right">
						<div>
							<div class="form_inner intro-content-form">
								<div class="form-wrap">
									<div class="title">
										Подбор и запрос <br> стоимости на <?php echo date('d.m.y'); ?><!--<b class="yagla-data"></b>-->
									</div>
									<form id="form1">
										<input type="hidden" name="leadform" value="Форма на первом экране">
										<div class="intro-content-form__item">
											<div>
											...
											<div>
												<div class="textarea-field">
													<label>Марка компрессора и тех.параметры</label>
	...
	<section class="catalog">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<h2>Ассортимент компрессоров</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3 col-sm-4 col-xs-6">
					<div class="catalog-item">
						...
						<div class="catalog-item_title">Винтовые <br>компрессоры</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-4 col-xs-6">
					<div class="catalog-item">
						...
						<div class="catalog-item_title">Поршневые <br>компрессоры</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-4 col-xs-6">
					<div class="catalog-item">
						...
						<div class="catalog-item_title">Дизельные <br>компрессоры</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-4 col-xs-6">
					<div class="catalog-item">
						...
						<div class="catalog-item_title">Спиральные <br>компрессоры</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-4 col-xs-6">
					<div class="catalog-item">
						...
						<div class="catalog-item_title">Медицинские <br>компрессоры</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-4 col-xs-6">
					<div class="catalog-item">
						...
						<div class="catalog-item_title">Дожимающие <br>бустеры 40 бар</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-4 col-xs-6">
					<div class="catalog-item">
						...
						<div class="catalog-item_title">Сепараторы <br>и фильтры</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-4 col-xs-6">
					<div class="catalog-item">
						...
						<div class="catalog-item_title">Осушители <br>сжатого воздуха</div>
					</div>
				</div>
				<div class="visible-xs col-xs-12">
					<div class="catalog-item">
						...
						<div class="catalog-item_title">Модульные компрессорные станции</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-4 col-xs-6">
					<div class="catalog-item">
						...
						<div class="catalog-item_title">Воздухосборники</div>
					</div>
				</div>
					...
					<div class="col-sm-8 col-xs-12">
						<div class="brands-list">
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="abac"><span></span></label>
								<div class="brand-img"><img src="img/brands/1.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="airpol"><span></span></label>
								<div class="brand-img"><img src="img/brands/2.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="almig"><span></span></label>
								<div class="brand-img"><img src="img/brands/3.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="alup"><span></span></label>
								<div class="brand-img"><img src="img/brands/4.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="berg"><span></span></label>
								<div class="brand-img"><img src="img/brands/5.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="ceccato"><span></span></label>
								<div class="brand-img"><img src="img/brands/6.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="comaro"><span></span></label>
								<div class="brand-img"><img src="img/brands/7.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="comprag"><span></span></label>
								<div class="brand-img"><img src="img/brands/8.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="dalgakiran"><span></span></label>
								<div class="brand-img"><img src="img/brands/9.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="dali"><span></span></label>
								<div class="brand-img"><img src="img/brands/10.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="ekomak"><span></span></label>
								<div class="brand-img"><img src="img/brands/11.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="fini"><span></span></label>
								<div class="brand-img"><img src="img/brands/12.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="mark"><span></span></label>
								<div class="brand-img"><img src="img/brands/13.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="remeza"><span></span></label>
								<div class="brand-img"><img src="img/brands/14.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="Арсенал"><span></span></label>
								<div class="brand-img"><img src="img/brands/15.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="АСО"><span></span></label>
								<div class="brand-img"><img src="img/brands/16.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="РКЗ"><span></span></label>
								<div class="brand-img"><img src="img/brands/17.jpg" alt=""></div>
							</div>
							<div class="brand-item">
								<label><input type="checkbox" name="brand[]" value="MMZ"><span></span></label>
								<div class="brand-img"><img src="img/brands/19.jpg" alt=""></div>
							</div>
						</div>
					</div>
...
<noscript><div><img src="https://mc.yandex.ru/watch/64948594" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
...
<script>
    window.onRoistatAllModulesLoaded = function() {
        window.roistat.leadHunter.onAfterSubmit = function(leadData) {
            ym(64948594, 'reachGoal', 'LEADHUNTER');
        }
    };
</script>
</body>
